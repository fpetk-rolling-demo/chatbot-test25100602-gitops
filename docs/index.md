...
The AI Software Template that was executed comes with a sample application. This application will be built from https://github.com/fpetk-rolling-demo/chatbot-test25100602, stored in [quay.io/tpetkos/chatbot-test25100602](https://quay.io/tpetkos/chatbot-test25100602) and deployed through ArgoCD. 
